...
// Source: go2s3/internal/explorer (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen -package mocks_explorer -destination mocks/explorer/repository.go go2s3/internal/explorer Repository
//
