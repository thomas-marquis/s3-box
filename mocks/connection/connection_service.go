...
func (m *MockConnectionService) GetActiveConnectionID(arg0 context.Context) (uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetActiveConnectionID", arg0)
...
func (mr *MockConnectionServiceMockRecorder) GetActiveConnectionID(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetActiveConnectionID", reflect.TypeOf((*MockConnectionService)(nil).GetActiveConnectionID), arg0)
}
