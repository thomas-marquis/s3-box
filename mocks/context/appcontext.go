...
// Source: go2s3/internal/ui/app/context (interfaces: AppContext)
//
// Generated by this command:
//
//	mockgen -package mocks_appcontext -destination mocks/context/appcontext.go go2s3/internal/ui/app/context AppContext
//
...
func (m *MockAppContext) Vm() *viewmodel.ViewModel {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Vm")
	ret0, _ := ret[0].(*viewmodel.ViewModel)
	return ret0
}
